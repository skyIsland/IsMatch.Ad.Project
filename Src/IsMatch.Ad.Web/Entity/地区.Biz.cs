...
namespace XCode.Membership
{
    ...
    public partial class Area : Entity<Area>
    {
        ...
        /// <returns>实体列表</returns>
        public static IList<Area> Search(String name, Int32 parentId, DateTime start, DateTime end, String key, PageParameter page)
        {
            ...
            if (!key.IsNullOrEmpty()) exp &= _.FullName.Contains(key) | _.UpdateUser.Contains(key) | _.UpdateIP.Contains(key) | _.Remark.Contains(key);

            return FindAll(exp, page);
        }

        // Select Count(Id) as Id,Category From Area Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Area> _CategoryCache = new FieldCache<Area>(nameof(Category))
        //{
