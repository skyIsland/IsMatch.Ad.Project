...
namespace XCode.Membership
{
    ...
    public partial class Log : Entity<Log>
    {
        ...
        public static IList<Log> Search(String category, String action, Int32 createUserId, DateTime start, DateTime end, String key, PageParameter page)
        {
            ...
            if (!key.IsNullOrEmpty()) exp &= _.UserName.Contains(key) | _.Ex4.Contains(key) | _.Ex5.Contains(key) | _.Ex6.Contains(key) | _.CreateUser.Contains(key) | _.CreateIP.Contains(key) | _.Remark.Contains(key);
