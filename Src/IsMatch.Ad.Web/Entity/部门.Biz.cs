...
namespace XCode.Membership
{
    ...
    public partial class Department : Entity<Department>
    {
        ...
        /// <param name="name">名称</param>
        /// <returns>实体对象</returns>
        public static Department FindByParentIDAndName(Int32 parentId, String name)
        {
            // 实体缓存
        ...
        public static IList<Department> Search(String code, String name, Int32 parentId, DateTime start, DateTime end, String key, PageParameter page)
        {
            ...
            if (!key.IsNullOrEmpty()) exp &= _.FullName.Contains(key) | _.Ex4.Contains(key) | _.Ex5.Contains(key) | _.Ex6.Contains(key) | _.CreateUser.Contains(key) | _.CreateIP.Contains(key) | _.UpdateUser.Contains(key) | _.UpdateIP.Contains(key) | _.Remark.Contains(key);
