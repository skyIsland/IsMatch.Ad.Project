...
namespace IsMatch.Models
{
    ...
    public partial class Category : Entity<Category>
    {
        ...
        // Select Count(ID) as ID,Category From Category Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By ID Desc limit 20
        //static readonly FieldCache<Category> _CategoryCache = new FieldCache<Category>(nameof(Category))
        //{
