...
{
    /// <summary>商品</summary>
    public partial class Goods : Entity<Goods>
    {
        #region 对象操作
        static Goods()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Goods[商品]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Goods[商品]数据！");
        //}
        ...
        public static Goods FindByID(Int32 id)
        {
            if (id <= 0) return null;
